...
export function ComparisonSection() {
    const features = [
        ...
        {
            name: "Soporte 24/7 Personalizado",
            wavenet: true,
            competitor: false,
        },
        {
            name: "Equipos de Última Generación",
            wavenet: true,
            competitor: true,
        },
        {
            name: "Intermediación en Telecomunicaciones",
            wavenet: true,
            competitor: false,
        },
        {
    ...
    return (
        <section className="w-full py-24 px-4 md:px-6 lg:px-8 bg-background">
